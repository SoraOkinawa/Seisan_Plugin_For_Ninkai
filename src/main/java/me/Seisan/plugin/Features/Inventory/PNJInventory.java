...
public class PNJInventory {
    public static Inventory getBanqueInventory(Player p){
        ...
        inv.setItem(11, ItemUtil.createItemStack(Material.GOLD_NUGGET, 1, "§2Billet de 10 Ryôs", Arrays.asList(), "ninkai", "ryos_billet"));
        inv.setItem(13, ItemUtil.createItemStack(Material.ARROW, ""));
        inv.setItem(15, ItemUtil.createItemStack(Material.GOLD_NUGGET, 10, "§6Ryô", Arrays.asList(), "ninkai", "ryos"));

        inv.setItem(20, ItemUtil.createItemStack(Material.GOLD_NUGGET, 10, "§6Ryô", Arrays.asList(), "ninkai", "ryos"));
        inv.setItem(22, ItemUtil.createItemStack(Material.ARROW, ""));
        inv.setItem(24, ItemUtil.createItemStack(Material.GOLD_NUGGET, 1, "§2Billet de 10 Ryôs", Arrays.asList(), "ninkai", "ryos_billet"));

        inv.setItem(29, ItemUtil.createItemStack(Material.GOLD_NUGGET, 10, "§2Billet de 10 Ryôs", Arrays.asList(), "ninkai", "ryos_billet"));
        inv.setItem(31, ItemUtil.createItemStack(Material.ARROW, ""));
        inv.setItem(33, ItemUtil.createItemStack(Material.GOLD_NUGGET, 1, "§2Liasse de 100 Ryôs", Arrays.asList(), "ninkai", "ryos_liasse"));

        inv.setItem(38, ItemUtil.createItemStack(Material.GOLD_NUGGET, 1, "§2Liasse de 100 Ryôs", Arrays.asList(), "ninkai", "ryos_liasse"));
        inv.setItem(40, ItemUtil.createItemStack(Material.ARROW, ""));
        inv.setItem(42, ItemUtil.createItemStack(Material.GOLD_NUGGET, 10, "§2Billet de 10 Ryôs", Arrays.asList(), "ninkai", "ryos_billet"));
    ...
    public static Inventory getVendeurJouet(Player p){
            ...
            inv.setItem(11, ItemUtil.createItemStack(Material.PAPER, 1, "§4Boîte surprise Sankamaisu", Arrays.asList("§7Achat d'une boite Sankamaisu de §2la première génération.", "§7La boîte coûte 10 ryos."), "ninkai", "boite_sankamaisu"));
            inv.setItem(15, ItemUtil.createItemStack(Material.PAPER,1, "§5Échange de figurine", Arrays.asList("§cHRP : §7Cliquez ici pour obtenir le menu vous permettant", "§7d'échanger cinq figurines contre une boîte."), "ninkai", "boite_sankamaisu"));
            inv.setItem(31, ItemUtil.createItemStack(Material.GOLD_NUGGET, 1, "§6Solde de vos ryôs", Arrays.asList("§7Voici les ryôs en votre possession : ", "§7Solde : "+getRyos(p), "§cHRP : §7Si votre solde est erroné, contactez §9Isami §7ou un §4MJ§7."), "ninkai", "ryos"));
                ...
                if (meta != null && meta.hasDisplayName()) {
                    switch (meta.getDisplayName()) {
                        ...
                        case "§2Liasse de 100 Ryôs":
                            if (ItemUtil.hasTag(item, "ninkai", "ryos_liasse")) {
